      ...
      elseif windows then
        ...
        _ExpectedAppDirs(
          where
            home_dir' = "/home/ed",
            user_data_dir' =
              "/home/ed/.local/share/appdirs",
            site_data_dirs' =
              [ "/usr/local/share/appdirs"
                "/usr/share/appdirs"
              ],
            user_config_dir' =
              "/home/ed/.config/appdirs",
            site_config_dirs' =
              ["/etc/xdg/appdirs"],
            user_cache_dir' =
              "/home/ed/.cache/appdirs",
            user_state_dir' =
              "/home/ed/.local/state/appdirs",
            user_log_dir' =
              "/home/ed/.cache/appdirs/log")
      end
      ...
      elseif windows then
        ...
        _ExpectedAppDirs(
          where
            home_dir' = "/home/ed",
            user_data_dir' =
              "/home/ed/.local/share/appdirs/0.4",
            site_data_dirs' =
              [ "/usr/local/share/appdirs/0.4"
                "/usr/share/appdirs/0.4"
              ],
            user_config_dir' =
              "/home/ed/.config/appdirs/0.4",
            site_config_dirs' =
              ["/etc/xdg/appdirs/0.4"],
            user_cache_dir' =
              "/home/ed/.cache/appdirs/0.4",
            user_state_dir' =
              "/home/ed/.local/state/appdirs/0.4",
            user_log_dir' =
              "/home/ed/.cache/appdirs/0.4/log")
      end
    _AppDirsTestUtil.test(
      app_dirs, expected, h)?
...
class \nodoc\ _AppDirsAppAuthorTest is UnitTest
  ...
  fun apply(h: TestHelper) ? =>
    ...
    let app_dirs =
      AppDirs(env_vars, "appdirs", "Matthias Wahl")
    let expected =
      ifdef osx then
        _ExpectedAppDirs(
          where
      ...
      elseif windows then
        ...
        _ExpectedAppDirs(
          where
            home_dir' = "/home/ed",
            user_data_dir' =
              "/home/ed/.my_own/data/appdirs",
            site_data_dirs' =
              [ "/etc/bla/appdirs"
                "/blubb/appdirs"
              ],
            user_config_dir' =
              "/home/ed/.my_config/appdirs",
            site_config_dirs' =
              ["/config/a b c/appdirs"],
            user_cache_dir' =
...
class \nodoc\ _AppDirsOsxAsUnixTest is UnitTest
  ...
  fun apply(h: TestHelper) ? =>
    ...
    let app_dirs =
      AppDirs(
        env_vars, "appdirs"
        where osx_as_unix = true)
    ifdef osx then
      let expected =
        _ExpectedAppDirs(
          where
            home_dir' =
              _AppDirsTestUtil.test_home(),
            user_data_dir' =
              "/Users/ed/.my_own/data/appdirs",
            site_data_dirs' =
              [ "/etc/bla/appdirs"
                "/blubb/appdirs"
              ],
            user_config_dir' =
              "/Users/ed/.my_config/appdirs",
            site_config_dirs' =
              ["/config/a b c/appdirs"],
            user_cache_dir' =
